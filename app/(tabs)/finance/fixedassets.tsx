...
import { Warehouse, ArrowLeft, Tag, MapPin, FileText } from 'lucide-react-native';
      ...
      <View style={styles.content}>
        <View style={[styles.placeholderCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
          <View style={[styles.iconContainer, { backgroundColor: '#0891B215' }]}>
            <Warehouse size={48} color="#0891B2" />
          </View>
          <Text style={[styles.title, { color: colors.text }]}>Fixed Assets</Text>
          <Text style={[styles.description, { color: colors.textSecondary }]}>
            Complete asset register with tracking, tagging, and lifecycle management.
          </Text>
          
          <View style={styles.featureList}>
            <View style={styles.featureItem}>
              <Tag size={18} color="#0891B2" />
              <Text style={[styles.featureText, { color: colors.text }]}>Asset Tagging</Text>
            </View>
            <View style={styles.featureItem}>
              <MapPin size={18} color="#0891B2" />
              <Text style={[styles.featureText, { color: colors.text }]}>Location Tracking</Text>
            </View>
            <View style={styles.featureItem}>
              <FileText size={18} color="#0891B2" />
              <Text style={[styles.featureText, { color: colors.text }]}>Lifecycle Management</Text>
            </View>
          </View>

          <View style={[styles.comingSoonBadge, { backgroundColor: '#0891B215' }]}>
            <Text style={[styles.comingSoonText, { color: '#0891B2' }]}>Coming Soon</Text>
          </View>
        </View>
