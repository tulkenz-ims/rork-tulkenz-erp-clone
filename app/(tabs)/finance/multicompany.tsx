...
import { Building, ArrowLeft, GitBranch, Settings, BarChart3 } from 'lucide-react-native';
import { useTheme } from '@/contexts/ThemeContext';

export default function MultiCompanyScreen() {
    ...
    <ScrollView style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={styles.content}>
        <View style={[styles.placeholderCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
          ...
          <Text style={[styles.title, { color: colors.text }]}>Multi-Company Management</Text>
          <Text style={[styles.description, { color: colors.textSecondary }]}>
            Manage multiple legal entities with centralized control and entity-specific reporting.
          </Text>
          
          <View style={styles.featureList}>
            <View style={styles.featureItem}>
              <GitBranch size={18} color="#6366F1" />
              <Text style={[styles.featureText, { color: colors.text }]}>Entity Hierarchy</Text>
            </View>
            <View style={styles.featureItem}>
              <Settings size={18} color="#6366F1" />
              <Text style={[styles.featureText, { color: colors.text }]}>Shared Chart of Accounts</Text>
            </View>
            <View style={styles.featureItem}>
              <BarChart3 size={18} color="#6366F1" />
              <Text style={[styles.featureText, { color: colors.text }]}>Cross-Entity Reporting</Text>
            </View>
          </View>

          <View style={[styles.comingSoonBadge, { backgroundColor: '#6366F115' }]}>
            <Text style={[styles.comingSoonText, { color: '#6366F1' }]}>Coming Soon</Text>
          </View>
        </View>
