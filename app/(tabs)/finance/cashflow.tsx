...
import { TrendingUp, ArrowLeft, Calendar, BarChart3, AlertTriangle } from 'lucide-react-native';
    ...
    <ScrollView style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={styles.content}>
        <View style={[styles.placeholderCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
          <View style={[styles.iconContainer, { backgroundColor: '#04785715' }]}>
            <TrendingUp size={48} color="#047857" />
          </View>
          <Text style={[styles.title, { color: colors.text }]}>Cash Flow Forecasting</Text>
          <Text style={[styles.description, { color: colors.textSecondary }]}>
            Project future cash positions based on AR/AP and planned transactions.
          </Text>
          
          <View style={styles.featureList}>
            <View style={styles.featureItem}>
              <Calendar size={18} color="#047857" />
              <Text style={[styles.featureText, { color: colors.text }]}>Rolling Forecasts</Text>
            </View>
            <View style={styles.featureItem}>
              <BarChart3 size={18} color="#047857" />
              <Text style={[styles.featureText, { color: colors.text }]}>Scenario Analysis</Text>
            </View>
            <View style={styles.featureItem}>
              <AlertTriangle size={18} color="#047857" />
              <Text style={[styles.featureText, { color: colors.text }]}>Shortage Alerts</Text>
            </View>
          </View>

          <View style={[styles.comingSoonBadge, { backgroundColor: '#04785715' }]}>
            <Text style={[styles.comingSoonText, { color: '#047857' }]}>Coming Soon</Text>
          </View>
        </View>
