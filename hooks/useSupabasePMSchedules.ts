    ...
    mutationFn: async (schedule: Omit<ExtendedPMSchedule, 'id' | 'organization_id' | 'created_at' | 'updated_at'>) => {
      ...
      const { data, error } = await supabase
        ...
        .insert({
          ...
          equipment_name: schedule.equipment_name || null,
          equipment_tag: schedule.equipment_tag || null,
          name: schedule.name,
          ...
          assigned_name: schedule.assigned_name || null,
          ...
          departments: (schedule as any).departments || ['1001'],
          tasks: (schedule as any).tasks || [],
          safety: (schedule as any).safety || null,
          photos: (schedule as any).photos || [],
          documents: (schedule as any).documents || null,
          signature_data: (schedule as any).signature_data || null,
          signed_by: (schedule as any).signed_by || null,
          signed_at: (schedule as any).signed_at || null,
        })
        .select()
        .single();
