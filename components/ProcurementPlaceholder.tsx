...
interface ProcurementPlaceholderProps {
  title: string;
  description: string;
...
export default function ProcurementPlaceholder({
  title,
  description,
  icon: Icon,
  color,
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        >
          ...
          <Text style={styles.backButtonText}>Back to Procurement</Text>
        </TouchableOpacity>
