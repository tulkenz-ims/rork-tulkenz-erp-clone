...
interface SanitationPlaceholderProps {
  title: string;
  description: string;
...
export default function SanitationPlaceholder({
  title,
  description,
  icon: Icon,
  color,
  category,
  features,
  backLabel = 'Back to Sanitation',
}: SanitationPlaceholderProps) {
      ...
      >
        ...
        <View style={[styles.statusCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
          ...
          <Text style={[styles.statusDescription, { color: colors.textSecondary }]}>
            This form is currently under development. The following features will be available:
          </Text>
        </View>
